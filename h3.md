...
Jos tämä ei suoraan toimi niin ```chmod o+x /path/to/ -R```, minun tapauksessa ```chmod o+x /home/joonas/ -R```, ```chmod o+x /home/joonas/public_html -R``` & ```chmod o+r /home/joonas/public_html/index.html```
...
Etusivu `http://localhost` näyttää nyt joonaksen hakemiston. Sivua voi muokata ilman sudoa:
...
- Tekstin jäsentelyyn käytetty [Claude-tekoälyä](https://claude.ai)
