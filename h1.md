...
![site.yml](site_yml.png)

---

### Virheviesti ennen roolin luontia

Ensimmäinen ajo antoi virheen, koska `hello`-roolia ei ollut vielä olemassa — tämä on odotettua:

![site.yml error](site_yml_error.png)
...
Hallintaa vaativat tehtävät tarvitsevat sudo-oikeudet. `become: true` lisätään `site.yml`-tiedostoon:
