...
### 4.12.1 Size and Complexity of Some DSLs (s. 112, pdf s. 130)

- Saltin DSL sisältää **510 tilatoimintoa** ja yli 75 000 sanan dokumentaation - enemmän kuin tyypillinen väitöskirja
- Puppet tarjoaa 113 funktiota ilman kontrollirakenteita, ja Puppetin omat kontrollirakenteet poikkeavat merkittävästi yleisistä ohjelmointikielistä
...
### 4.12.2 Use of DSL Functions in Case Configuration (s. 112-115, pdf s. 130-133)
...
### 4.12.3.1 Dependencies Between Main Functions (s. 115-117, pdf s. 133-135)
...
- `apt` tarkistaa onko paketti jo asennettu ennen asennusta
